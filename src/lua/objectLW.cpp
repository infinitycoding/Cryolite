...
NEWBEGIN(newObject)
    ...
    switch(getargc())
    {
        ...
        case 3:
            ...
            addInstance(Object, Object(arg1, arg2));
        break;
        ...
        case 4:
            ...
            addInstance(Object, Object(arg1, arg2, *arg3));
        break;
...
CBEGIN(getAS)
    ...
    CHECKEND
CEND(1, LDBL(getInstance(Object)->approximationSphere))
...
CBEGIN(setAS)
    ...
    CHECK(isnumber(1))
        getarg(newAS=LDBL());
        getInstance(Object)->approximationSphere = newAS;
    ELSE
...
CBEGIN(addToScene)
    ...
    mainScene->addObject(getInstance(Object));
CEND(0)
